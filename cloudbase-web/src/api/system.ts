...
export function deleteUser(data: { id: number }): Promise<void> { return request({ url: '/sys/user/delete', method: 'post', data }) }
...
export function getUserRoles(data: { id: number }): Promise<number[]> { return request({ url: '/sys/user/roles', method: 'post', data }) }
...
export function resetUserPwd(data: { userId: number; newPassword: string }): Promise<void> { return request({ url: '/sys/user/resetPwd', method: 'post', data }) }
...
export function deleteRole(data: { id: number }): Promise<void> { return request({ url: '/sys/role/delete', method: 'post', data }) }
...
export function deleteMenu(data: { id: number }): Promise<void> { return request({ url: '/sys/menu/delete', method: 'post', data }) }
...
export function deleteDict(data: { id: number }): Promise<void> { return request({ url: '/sys/dict/delete', method: 'post', data }) }
...
export function deleteDept(data: { id: number }): Promise<void> { return request({ url: '/sys/dept/delete', method: 'post', data }) }
